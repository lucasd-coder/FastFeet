...
// 	protoc        v3.21.12
// source: client/business_service/order_handler.proto
...
var File_client_business_service_order_handler_proto protoreflect.FileDescriptor

var file_client_business_service_order_handler_proto_rawDesc = []byte{
	0x0a, 0x2b, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x2f, 0x62, 0x75, 0x73, 0x69, 0x6e, 0x65, 0x73,
	0x73, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f,
...
var file_client_business_service_order_handler_proto_goTypes = []interface{}{
	(*GetAllOrderRequest)(nil),  // 0: pb.GetAllOrderRequest
	(*GetAllOrderResponse)(nil), // 1: pb.GetAllOrderResponse
}
var file_client_business_service_order_handler_proto_depIdxs = []int32{
...
func init() { file_client_business_service_order_handler_proto_init() }
func file_client_business_service_order_handler_proto_init() {
	if File_client_business_service_order_handler_proto != nil {
		return
	}
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_client_business_service_order_handler_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   0,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_client_business_service_order_handler_proto_goTypes,
		DependencyIndexes: file_client_business_service_order_handler_proto_depIdxs,
	}.Build()
	File_client_business_service_order_handler_proto = out.File
	file_client_business_service_order_handler_proto_rawDesc = nil
	file_client_business_service_order_handler_proto_goTypes = nil
	file_client_business_service_order_handler_proto_depIdxs = nil
}
