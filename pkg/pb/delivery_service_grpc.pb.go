...
const (
	DeliveryService_Save_FullMethodName = "/pb.DeliveryService/Save"
)
...
type DeliveryServiceClient interface {
	Save(ctx context.Context, in *DeliveryRequest, opts ...grpc.CallOption) (*DeliveryResponse, error)
}
...
func (c *deliveryServiceClient) Save(ctx context.Context, in *DeliveryRequest, opts ...grpc.CallOption) (*DeliveryResponse, error) {
	out := new(DeliveryResponse)
	err := c.cc.Invoke(ctx, DeliveryService_Save_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeliveryServiceServer interface {
	Save(context.Context, *DeliveryRequest) (*DeliveryResponse, error)
...
func (UnimplementedDeliveryServiceServer) Save(context.Context, *DeliveryRequest) (*DeliveryResponse, error) {
...
func _DeliveryService_Save_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeliveryServiceServer).Save(ctx, req.(*DeliveryRequest))
	}
...
var DeliveryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "service/delivery_service.proto",
}
