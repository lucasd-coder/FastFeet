...
func (c *orderServiceClient) GetAllOrders(ctx context.Context, in *GetAllOrderRequest, opts ...grpc.CallOption) (*GetAllOrderResponse, error) {
...
func (UnimplementedOrderServiceServer) GetAllOrders(context.Context, *GetAllOrderRequest) (*GetAllOrderResponse, error) {
...
func _OrderService_GetAllOrders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetAllOrders(ctx, req.(*GetAllOrderRequest))
	}
	return interceptor(ctx, in, info, handler)
}
