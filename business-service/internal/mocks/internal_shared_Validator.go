...
type mockConstructorTestingTNewValidator_internal_shared interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewValidator_internal_shared(t mockConstructorTestingTNewValidator_internal_shared) *Validator_internal_shared {
